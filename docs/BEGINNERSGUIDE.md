...
Click the "Fork" button in the top-right corner of the [GitHub repository](https://github.com/Cwf1997/hauntingground). This will create a copy of the repository on your own GitHub account.
...
Navigate to the `hauntingground` directory in the terminal, and run the following command:
